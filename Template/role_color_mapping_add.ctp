        ...
        <?= $this->Form->create($notification) ?>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <?= $this->Form->input('client_id', array('id'=>'client_id','type'=>'select', 'options'=> $clients, 'label'=>'Clients','empty'=>'--Select--','class'=>'form-control','required'=>'required','onchange'=>'getClientRoles(this);')); 
                            ?>
                        </div>
                    </div>
