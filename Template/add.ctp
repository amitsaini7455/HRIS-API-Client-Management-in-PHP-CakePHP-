<?php ?>
<h3 style="color:#2d6f96;line-height:0px;">Add</h3>
...
<div class="well">
    <div class="padding-md bg-white" style="border-top:3px solid #d2d6de;">
        <div class="table-responsive1" id="add_client">
            ...
            <div class="col-md-4">
                <div class="form-group">
                    <?= $this->Form->input('module', array('type' => 'select', 'id' => 'module', 'options' => $moduleArray, 'label' => 'Module', 'multiple' => true, 'class' => 'form-control moduleList', 'onchange' => 'handleModuleChange()')); ?>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="form-group">
                <div id="image-field-container" style="display: none;">
